<header class="bg-trueGray-700 sticky top-0" x-data="dropdown()">
    <div class="container flex items-center h-16 justify-between md:justify-start">
        <a :class="{'bg-opacity-100 text-orange-500': open}" x-on:click="show()"
            class="flex flex-col items-center justify-center order-last md:order-first px-6 pd:px-4 bg-white bg-opacity-25 text-white cursor-pointer font-semibold h-16">
        ...
        <div class="px-6 relative hidden md:block">
            @auth
            ...
            @else
                ...
                <x-jet-dropdown align="right" width="48">
                    ...
                    <x-slot name="trigger">
                        <i class="fas fa-user-circle text-white text-x1 cursor-pointer"></i>
                    </x-slot>
